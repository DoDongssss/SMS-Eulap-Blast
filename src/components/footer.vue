<template>
    <div class="bg-base-200">
        <footer class="footer flex flex-col items-center px-12 text-default gap-0">
                        ...
                        <div class="flex flex-col gap-3">
                            <p class="flex items-center gap-2 text-default">
                                <span class="rounded-full bg-secondary/50">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="ionicon h-[28px] w-[28px] p-[5px]" viewBox="0 0 512 512"><path d="M451 374c-15.88-16-54.34-39.35-73-48.76-24.3-12.24-26.3-13.24-45.4.95-12.74 9.47-21.21 17.93-36.12 14.75s-47.31-21.11-75.68-49.39-47.34-61.62-50.53-76.48 5.41-23.23 14.79-36c13.22-18 12.22-21 .92-45.3-8.81-18.9-32.84-57-48.9-72.8C119.9 44 119.9 47 108.83 51.6A160.15 160.15 0 0083 65.37C67 76 58.12 84.83 51.91 98.1s-9 44.38 23.07 102.64 54.57 88.05 101.14 134.49S258.5 406.64 310.85 436c64.76 36.27 89.6 29.2 102.91 23s22.18-15 32.83-31a159.09 159.09 0 0013.8-25.8C465 391.17 468 391.17 451 374z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/>
                                    </svg>
                                </span>
                            ...
                            <p class="flex items-center gap-2 text-default">
                                <span class="rounded-full bg-secondary/50">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="ionicon h-[28px] w-[28px] p-[5px]" viewBox="0 0 512 512"><path d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208 208-93.13 208-208S370.87 48 256 48z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path d="M256 48c-58.07 0-112.67 93.13-112.67 208S197.93 464 256 464s112.67-93.13 112.67-208S314.07 48 256 48z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path d="M117.33 117.33c38.24 27.15 86.38 43.34 138.67 43.34s100.43-16.19 138.67-43.34M394.67 394.67c-38.24-27.15-86.38-43.34-138.67-43.34s-100.43 16.19-138.67 43.34" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32" d="M256 48v416M464 256H48"/>
                                    </svg>
                                </span>
                                <span class="">www.eulap.com</span>
                            </p>
                        </div>
                        <div class="flex flex-col gap-3">
                            <p class="flex items-center gap-2 text-default">
                                <span class="rounded-full bg-secondary/50">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="ionicon h-[28px] w-[28px] p-[5px]" viewBox="0 0 512 512"><rect x="48" y="96" width="416" height="320" rx="40" ry="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M112 160l144 112 144-112"/>
                                    </svg>
                                </span>
                                <span class="">info@eulap.com</span>
                            </p>
                            <p class="flex items-center gap-2 text-default">
                                <span class="rounded-full bg-secondary/50">
                                ...
                                <span class="">SCJ Bldg., Abad Santos St. Zone 3, Koronadal City</span>
                            </p>
                        </div>
                    </div>
            ...
            <div class="w-full flex flex-col items-center justify-center py-8 border-t border-default/20">
                <div>
