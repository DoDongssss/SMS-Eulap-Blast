<template>
    <div class="flex w-full xl:h-screen p-6 flex-col items-center xl:flex-row">
        ...
        <div class="flex flex-col items-center justify-center w-full sm:w-[90%] xl:w-[40%] xl:px-12 ">
            ...
            <div class="flex justify-center xl:justify-end w-full mt-6">
                <button class="flex items-center px-4 py-[.60rem] cursor-pointer text-[1rem] text-white transition duration-200 ease-in-out rounded-md bg-primary/80 hover:bg-primary">Learn More</button>
            </div>
