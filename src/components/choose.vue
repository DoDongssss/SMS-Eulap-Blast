        ...
        <div class="flex flex-wrap gap-6 xl:gap-12 items-start xl:items-center justify-center mt-[3rem] xl:mt-[5rem]">
            <div class="flex flex-col xl:flex-row items-center justify-center gap-6 w-full xl:w-[550px] px-10 py-5 bg-white rounded-xl c-box-shadow p-6">
                ...
                <div class="flex flex-col items-center xl:items-start gap-4">
                    <h1 class="font-semibold text-primary text-2xl">Seamless Integration</h1>
            ...
            <div class="flex flex-col xl:flex-row items-center justify-center gap-6 w-full xl:w-[550px] px-10 py-5 bg-white rounded-xl c-box-shadow p-6">
                ...
                <div class="flex flex-col items-center xl:items-start gap-4">
                    <h1 class="font-semibold text-primary text-2xl">Scalability</h1>
            ...
            <div class="flex flex-col xl:flex-row items-center justify-center gap-6 w-full xl:w-[550px] px-10 py-5 bg-white rounded-xl c-box-shadow p-6">
                ...
                <div class="flex flex-col items-center xl:items-start gap-4">
                    <h1 class="font-semibold text-primary text-2xl">Support</h1>
                    <p class="text-default text-justify">At Eulap, we believe in putting our customers first. Our team provides top-notch customer support, assisting you at every step of your journey. We are here to answer your questions and resolve any concerns promptly.</p>
                </div>
            </div>
        </div>
    </div>
