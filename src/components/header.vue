<template>
   ...
   >
      <div class="navbar-start w-auto md:hidden">
         <div class="dropdown">
            <label tabindex="0" class="btn btn-circle btn-ghost text-default">
               <svg
            ...
            <ul
               tabindex="0"
               class="menu dropdown-content rounded-box menu-sm z-[1] mt-4 w-52 gap-4 bg-secondary p-4 shadow"
            >
               <li
               ...
               <li
                  class="text cursor-pointer list-none text-[1.2rem] text-default hover:text-primary"
               >
      ...
      <a href="#"
         ><img src="/images/logo.png" alt="" class="w-[120px] py-4"
      /></a>
      ...
      <div class="flex items-center justify-center gap-4">
         ...
         <label class="swap-rotate swap">
            ...
            <svg
               viewBox="0 0 24 24"
               fill="none"
               class="swap-off h-6 w-6 fill-primary/90"
            >
               <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
